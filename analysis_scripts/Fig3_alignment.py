...
sound_dir = "Z:/Wayan/Lightbead/Flies/Method paper/06192024/Alignment/"
data = h5py.File(sound_dir +'20240619_1456.sound_server.h5', 'r')


#### path to I2C file
# TODO CHANGE THIS TO THE DESIRED FOLDER AND FILE NAME
I2C_dir = 'Z:/Wayan/Lightbead/Flies/Method paper/06192024/I2C_frames/a1_r1/'
# Name of I2C file
file = 'a1_r1.txt'
...
data_dir_dff = "V:/Wayan/LightBeadsMicroscopeDATA/Flies/Method paper data/Analyzed/06192024_8m/zscored/a1_r1/" 
# Trial name
# TODO CHANGE THIS TO THE TRIAL'S NAME CONTAINED IN RAW TIFF FILE NAME
fly = ['06192024_8m_a1_r1']   
### Number of volumes 
...
# TODO CHANGE THIS TO THE DESIRED FOLDER
path_export = 'D:/Wayan/LightBead/method paper/dico data/zscored/60Hz/1000/'

### Name of the data to be exported
# TODO CHANGE THIS TO THE DESIRED NAME
fly_dic ='GCaMP8m_06192024_a1_r1'
...
start_index = start_block_seconds*44100
...
audio_stim = loadmat(dropbox_dir + 'pulse_train_forplotting.mat')
...
if generate_dic:
   ...
   Scope = 'LB'
   ### Data   
   dic = {'time_audio_aligned': stimTime[0],'time_audio_raw': stimTime[0] + time_audio,'pulse_song': audio_stim['pulse_song'], 'dffs_raw': dffs,\
         ...
         'n_volumes_raw':dffs.shape[1],'n_volumes_aligned':dffs_align.shape[1],  'Frame_rate': Hz}
