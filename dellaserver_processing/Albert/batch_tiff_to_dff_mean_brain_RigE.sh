...
NUMVOLS=600 #need to count 0, so is last plus one: 192 for 10 files test, 600 for all
PROJECTOR=true #boolean: projector subtraction yes or no
...
T_THRESH=95 #temporal threshold for projector correction (if proj is false, not used) percentile for de-meaning background pixels
