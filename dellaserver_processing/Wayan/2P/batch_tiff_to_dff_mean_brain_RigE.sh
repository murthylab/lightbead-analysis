...
python3 tiff_to_dff_mean_brain_RigE.py --tiffdir $TIFFDIR --outdir $OUTDIR --flytrial $FLYTRIAL # within tiff_to_dff you can change green/red channel, type of alignment
