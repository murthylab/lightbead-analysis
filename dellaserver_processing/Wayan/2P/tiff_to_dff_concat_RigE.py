def main():
    ...
    if doConcatMoCo:
        vols_RigE.concat_volumes(green_moco_dir, greenpath, xdim=XDIM, ydim=YDIM, zdim=ZDIM)
        vols_RigE.concat_volumes(red_moco_dir, redpath, xdim=XDIM, ydim=YDIM, zdim=ZDIM)
