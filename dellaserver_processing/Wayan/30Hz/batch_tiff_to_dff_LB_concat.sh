...
python3 tiff_to_dff_LB_concat.py --tiffdir $TIFFDIR --outdir $OUTDIR --flytrial $FLYTRIAL # within tiff_to_dff you can change green/red channel, type of alignment
